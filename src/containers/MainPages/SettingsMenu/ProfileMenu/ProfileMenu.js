    ...
    <>
      <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
        <Tooltip title="Account settings">
          ...
          >
            <Avatar sx={isSm600down ? { width: 100, height: 100 }: { width: 50, height: 50 }}
                    src={user?.avatar ? BASE_URL + user.avatar : noAvatar}
            >
              M
            </Avatar>
          </IconButton>
      ...
      >
        ...
        <MenuItem onClick={() => dispatch(logOutUser())} disabled={logOutLoading}>
          <ListItemIcon>
